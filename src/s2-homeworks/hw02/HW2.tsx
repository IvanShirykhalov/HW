...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    ...
    if (filter === 'high') {
        return affairs = defaultAffairs.filter(a => a.priority === 'high')
    }
    if (filter === 'middle') {
        return affairs = defaultAffairs.filter(a => a.priority === 'middle')
    }
    if (filter === 'low') {
        return affairs = defaultAffairs.filter(a => a.priority === 'low')
    }
